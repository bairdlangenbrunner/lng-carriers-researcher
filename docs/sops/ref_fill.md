...
A `Delivery year` moved **later** on an undelivered vessel (a roll-forward) wants **at least one source besides the vessel database** that scheduled it (Baird directive 2026-09-21). shipvault alone is a lead-grade schedule: one source, Yellow, held.
