...
| 2026-09-17 | combined | sep-17-pass roll-up of the eight proposal batches + the IGU comparison (review aid, not an apply source) | [folder](2026-09-17_1017ET_sep-17-pass_combined/) | 20 sheets, 1,912 proposals (1,323 accept / 589 hold) keyed by live sheet row; backend-shape tab; `igu_findings` tab; report-page generator |
...
| 2026-09-17 | fix | what the IGU World LNG Report 2026 prints, the report PDF as sole ref (IG §5.4): blank Vessel / Cargo type, renames, delivery years, propulsion, load corruption (sep-17-pass 8) | [folder](2026-09-17_1654ET_fix_igu2026_sourced/) | 468 cells / 328 rows (443 accept, 25 hold); 32 manual-review values (vocabulary / stylization picks); apply via `apply_patch.csv` |
