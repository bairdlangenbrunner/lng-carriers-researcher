...
**Mode:** fix  ·  **Proposals:** 468 (auto-safe 443, needs-decision 25)  ·  **Conflicts:** 0  ·  **Documented blanks:** 0

## ✅ Auto-safe — accept in bulk (Green / derivable)

By field: Vessel type ×296, Cargo type ×79, Name ×28, Propulsion type ×19, Delivery year ×15, Capacity ×3, Capacity units ×2, Status ×1

These 443 are default-`accept` in `decisions.csv`. Skim or trust; nothing here needs a per-item call.

## ⚠️ Needs a decision (Yellow / Red / unknown)

- **row 721** · Name: `Karadeniz LNGT Antarctica` (Y) — 'Karmol LNGT Powership Antarctica' -> 'Karadeniz LNGT Antarctica': IGU restyles the Karadeniz / Karmol powership names — a label choice, not a rename [IGU 2026 Appendix 3 fleet table, PDF p.77; IMO 8608872; sole source per Baird ruling 2026-09-17]
- **row 811** · Name: `Karadeniz LNGT Americas` (Y) — 'LNGT Americas' -> 'Karadeniz LNGT Americas': IGU restyling of a Karadeniz name — label choice [IGU 2026 Appendix 3 fleet table, PDF p.71; IMO 9045132; sole source per Baird ruling 2026-09-17]
- **row 726** · Name: `Karadeniz LNGT Powership Black Sea` (Y) — 'KLNGTP Black Sea' -> 'Karadeniz LNGT Powership Black Sea': IGU restyling of a Karadeniz name — label choice [IGU 2026 Appendix 3 fleet table, PDF p.70; IMO 9064073; sole source per Baird ruling 2026-09-17]
- **row 727** · Name: `Karadeniz LNGT Powership Marmara` (Y) — 'KLNGTP Marmara' -> 'Karadeniz LNGT Powership Marmara': IGU restyling of a Karadeniz name — label choice [IGU 2026 Appendix 3 fleet table, PDF p.70; IMO 9064085; sole source per Baird ruling 2026-09-17]
